...
const countryStories = {
  president: { number: 1, point: [400, 520], title: 'Elected student body president.', description: 'At Walsh University, I was a government & foreign affairs minor. That interest in public service inspired me to run for student body president as a sophomore. After being elected, my administration was able to implement a new student ID, increase environmental improvements across the cafeterias, and improve student involvement in campus decision making.', url: 'https://youtu.be/5uaEyriSL3A', action: 'Watch the video', message: 'Completed!' },
